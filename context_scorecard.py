...
def evaluate_signal(
    ...
    if has_blowoff:
        ...
        grade = 'SKIP'
    elif pct >= 0.70 and high_pass >= 4 and not has_critical_fail:
        grade = 'STRONG'
    elif pct >= 0.50 and high_pass >= 3:
        grade = 'MODERATE'
    ...
    if grade == 'STRONG':
        # Nếu có CLIMAX_VOL thì có thể FULL SIZE
        if vol_ctx == 'CLIMAX_VOL' and score >= SCORE_GOOD:
            sizing = 'FULL SIZE 💪'

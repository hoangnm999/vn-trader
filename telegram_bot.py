...
# ── ML_CONFIRMED_WATCHLIST — Mã đã xác nhận edge qua backtest 54 mã ─────────
...
#
# Tier A (WR≥58%, PnL≥2%, PF≥1.5):  HCM, FRT, VCI
# Tier B (WR≥52%, PnL≥1%, PF≥1.3):  DGC, NKG, SSI, MWG
#
# Cập nhật: Sprint 7 — sau backtest 54 mã (20 core + 34 extended)

                    ...
                    try:
                        ...
                        if (_ms.get('tier1_pass') and _ms.get('grade') in ('PASS', 'STRONG')
                            ...
                            if (last_ms[0] != 'MOMENTUM'
                                ...
                                if msg:
                                    broadcast(msg)
                                    logger.info(f'ML alert [{_ml_tier}] [{_ms.get("grade")}]: {sym} score={_ms.get("score")}')
                                    time.sleep(2)

...
# ── Cấu hình Scanner ────────────────────────────────────────────────────────
SCAN_INTERVAL_MIN   = 10   # Quét signal mỗi 10 phút trong giờ giao dịch
    ...
    while True:
        try:
            ...
            if weekday < 5 and in_session and report_slot != _last_report_slot:
                ...
                send('&#x1F4CB; <b>Bao cao dinh ky — ' + label + '</b>', CHAT_ID)
            ...
            # ── Báo cáo TEST 16:05 — xác nhận hệ thống hoạt động ────────────
            if weekday < 5 and h == 16 and m == 5 and _last_scan_slot != (total_min + 9999):
                _last_scan_slot = total_min + 9999
                send('&#x1F9EA; <b>[TEST] Bao cao 16:05 — ' + now.strftime('%d/%m') + '</b>\n'
            ...
            if weekday < 5 and in_session and scan_slot != _last_scan_slot:

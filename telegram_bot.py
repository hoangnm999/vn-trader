...
def _add_paper_trade(symbol, price, score, sl_pct, tp_pct):
    ...
    # Expire: tính theo ngày giao dịch thực tế (bỏ T7, CN)
    # PAPER_MONTHS * 30 calendar days → ~PAPER_MONTHS * 22 trading days
    trading_days_expire = PAPER_MONTHS * 22
    expire = _trading_days_after(today, trading_days_expire)

    # Settlement: T+3 ngày giao dịch

...
_BF_CONTEXT_RULES = {
    ...
    # Mã mới S20 — từ /scabt analysis
    'VCI':  [{'cond': 'vni_flat', 'reason': 'VCI VNI FLAT: Exp=+0.50% Δ-1.24% n=16L'},
             {'cond': 'vol_low',  'reason': 'VCI Vol LOW: Exp=+0.28% Δ-1.46% n=20L'}],
    'HPG':  [{'cond': 'vni_flat', 'reason': 'HPG VNI FLAT: Exp=-0.64% WR=46% n=22L'}],
}

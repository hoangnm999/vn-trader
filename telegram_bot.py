...
def _build_conclusion(score_a, score_ab, b_delta, b_details,
    ...
    if is_watchlist and score_min != 65:
        ...
        if effective_action != action:
            lines += (f'\n&#x26A0; <i>Luu y: {sym} can score >= {score_min} '
                      f'(backtest). Voi score {score_ab}/100 → thuc te: <b>{effective_action}</b></i>\n')
        else:
            lines += f'\n<i>Nguong MUA cua {sym}: >= {score_min} (tu backtest)</i>\n'
                ...
                try:
                    ...
                    for sym in list(WATCHLIST_META.keys()):
                        ...
                        if d and not d.get('error'):
                            ...
                            ma50_icon = '&#x1F7E2;' if (above50 and slope50) else ('&#x1F7E1;' if above50 else '&#x1F534;')

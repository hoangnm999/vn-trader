"""
shark_detector.py v4.1
======================
v4.1 changes (sprint 5):
[F] load_foreign_flow: fix column mapping cho TCBS (buyForeignQtty) + VCI patterns  
[F] Thêm TCBS REST API fallback (apipubaws.tcbs.com.vn/stock-insight)
[F] Log rõ ràng khi foreign data load thành công/thất bại
"""

...
SYMBOL_CONFIG = {
    ...
    'MBB': {'sl': 0.05, 'tp': 0.07, 'min_score': 55, 'b_filter': False, 'group': 'Ngan hang',    'wf_verdict': 'CHAP_NHAN',  'entry': 'T',   'entry_note': 'T bat buoc (-10.9% WR neu T+1)', 'shark_mode': 'S', 'shark_min': 55, 'use_regime': False, 'trigger_mode': 'filter_confirm'},
    ...
    'HSG': {'sl': 0.07, 'tp': 0.10, 'min_score': 65, 'b_filter': False, 'group': 'Thep',         'wf_verdict': 'CHAP_NHAN'  , 'shark_mode': 'none', 'use_regime': False, 'use_vwap': False, 'trigger_mode': 'score_primary'},
    ...
    'VND': {'sl': 0.05, 'tp': 0.09, 'min_score': 65, 'b_filter': False, 'group': 'Chung khoan',  'wf_verdict': 'CHAP_NHAN'  , 'shark_mode': 'none', 'use_regime': False, 'use_vwap': False, 'trigger_mode': 'score_primary'},
    ...
    'PDR': {'sl': 0.07, 'tp': 0.14, 'min_score': 55, 'b_filter': False, 'group': 'Bat dong san', 'wf_verdict': 'CHAP_NHAN', 'entry': 'T',   'entry_note': 'T bat buoc (-14.2% WR neu T+1)', 'shark_mode': 'dangerous', 'use_regime': False, 'trigger_mode': 'filter_confirm', 'min_conviction': 2.5},
    # WR=46.9% PF=1.43 OOS=51.3% | ⚠ Entry T BẮT BUỘC (T+1 kém -14.2%)
    'NVL': {'sl': 0.07, 'tp': 0.14, 'min_score': 55, 'b_filter': False, 'group': 'Bat dong san', 'wf_verdict': 'CHAP_NHAN', 'entry': 'T+1', 'entry_note': 'T+1 tot hon T (+0.53% PnL)', 'shark_mode': 'qualitative', 'use_regime': False, 'use_vwap': False, 'trigger_mode': 'filter_confirm'},
    ...
    'SZC': {'sl': 0.07, 'tp': 0.14, 'min_score': 45, 'group': 'KCN',          'wf_verdict': 'YEU'      , 'shark_mode': 'S', 'shark_min': 60, 'use_regime': False, 'use_vwap': False, 'trigger_mode': 'filter_led'},
    ...
    'TCB': {'sl': 0.05, 'tp': 0.09, 'min_score': 55, 'group': 'Ngan hang',    'wf_verdict': 'YEU'         , 'shark_mode': 'S', 'shark_min': 60, 'use_regime': False, 'entry': 'T+1', 'entry_note': 'T+1 tot hon T (+12.5% WR)', 'trigger_mode': 'filter_confirm'},
    'VPB': {'sl': 0.05, 'tp': 0.09, 'min_score': 55, 'group': 'Ngan hang',    'wf_verdict': 'YEU'         , 'shark_mode': 'S', 'shark_min': 65, 'use_regime': False, 'trigger_mode': 'filter_confirm'},
    ...
    'CMG': {'sl': 0.05, 'tp': 0.09, 'min_score': 55, 'group': 'Cong nghe',    'wf_verdict': 'YEU'         , 'shark_mode': 'AS', 'shark_min': 60, 'use_regime': True, 'entry': 'T+1', 'entry_note': 'T+1 tot hon T (+3.8% WR)', 'trigger_mode': 'filter_confirm'},

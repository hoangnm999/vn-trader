...
SYMBOL_CONFIG = {
    ...
    'NKG': {'sl': 0.07, 'tp': 0.10, 'min_score': 65, 'b_filter': False, 'group': 'Thep',         'wf_verdict': 'TOT',  'entry': 'T',   'entry_note': 'T bat buoc (-4.6% WR neu T+1)'},
    # WR=58.1% PF=1.66 OOS=65.0% | TP 14%→10% (Avg Win +7.1%) | Entry: T BẮT BUỘC (-4.6% WR nếu T+1)
    'MBB': {'sl': 0.05, 'tp': 0.07, 'min_score': 65, 'b_filter': False, 'group': 'Ngan hang',    'wf_verdict': 'TOT',  'entry': 'T',   'entry_note': 'T bat buoc (-10.9% WR neu T+1)'},
    ...
    'NVL': {'sl': 0.07, 'tp': 0.14, 'min_score': 78, 'b_filter': False, 'group': 'Bat dong san', 'wf_verdict': 'CHAP', 'entry': 'T+1', 'entry_note': 'T+1 tot hon T (+0.53% PnL)'},

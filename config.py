...
# Session 20: thêm PVD, VCI, HPG từ /scabt_hose + /scabt analysis. wf_verdict=CHUA_BT — cần chạy /bt.
# ⚠ Sector concentration: VND+SSI+CTS+VCI = 4/13 mã chứng khoán — tránh trade đồng thời.
